========================================================================
    APLICACIÓN: AX Loader Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación AX Loader.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación AX Loader.
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado AX Loader.pch y un archivo de tipos precompilados llamado StdAfx.obj.
